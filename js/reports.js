    ...
    document.querySelectorAll('.nav-item').forEach(item => {
        item.addEventListener('click', (e) => {
            ...
            if (activeTab === 'summary') {
                ...
                document.getElementById('reportContentView').innerHTML = `
...
async function fetchAndProcessSummaryData() {
    ...
    data.forEach(entry => {
        ...
        if (filterState.groupBy === 'project') {
            ...
            groupKey = entry.employee ? entry.employee.email : 'No Employee';
        }
...
function updateHeaderStats(totalSec, billableSec, nonBillableSec, entriesCount, empCount) {
    ...
    document.getElementById('statBillableTime').textContent = formatHMS(billableSec);
    document.getElementById('statNonBillableTime').textContent = formatHMS(nonBillableSec);
    document.getElementById('statTotalEntries').textContent = entriesCount;
    document.getElementById('statTotalEmployees').textContent = empCount;
}
